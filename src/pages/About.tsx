...
const About = () => {
  ...
  const clients = [
    ...
    {
      name: "FoodieChain",
      logo: "https://images.unsplash.com/photo-1487887235947-a955ef187fcc?w=200&h=200&fit=crop",
    },
    {
      name: "GlobalBank",
      logo: "https://images.unsplash.com/photo-1465146344425-f00d5f5c8f07?w=200&h=200&fit=crop",
    },
    {
      name: "EcoGreen",
      logo: "https://images.unsplash.com/photo-1500375592092-40eb2168fd21?w=200&h=200&fit=crop",
    },
    {
      name: "HealthPlus",
      logo: "https://images.unsplash.com/photo-1482881497185-d4a9ddbe4151?w=200&h=200&fit=crop",
    },
  ];
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="text-center">
              ...
              <p className="text-xl max-w-2xl mx-auto text-muted-foreground">
                We're a passionate team of creatives dedicated to bringing your
                brand's story to life through compelling visual content.
              </p>
            </div>
          </div>
        </section>
                  ...
                  <div className="grid lg:grid-cols-2 gap-6 md:gap-8 items-start">
                    <div className="space-y-4 order-2 lg:order-1">
                      <p className="text-base md:text-lg leading-relaxed text-muted-foreground">
                        Founded in 2018, Love Regality Productions emerged from
                        a simple belief: every brand has a unique story worth
                        telling. We specialize in creating commercials that
                        don't just sell products, but build emotional
                        connections between brands and their audiences.
                      </p>

                      <p className="text-base md:text-lg leading-relaxed text-muted-foreground">
                        Our approach combines cutting-edge technology with
                        timeless storytelling principles. We believe that the
                        best commercials are the ones people actually want to
                        watch, share, and remember.
                      </p>
                    </div>

                    <div className="space-y-4 order-1 lg:order-2">
                      <div className=" p-4 mb-4 rounded-lg bg-white/10 border border-white/20">
                        <h3 className="text-xl md:text-2xl font-bold mb-2 ">
                          Our Mission
                        </h3>
                        <p className="text-sm md:text-lg text-muted-foreground">
                          To create visual content that not only captures
                          attention but also drives meaningful engagement and
        ...
        <section className="py-16">
          <div className="container mx-auto px-6">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold mb-4 text-orange-400">
                Trusted by{" "}
                <span className="text-4xl font-bold mb-4 text-orange-400">
                  Industry Leaders
                </span>
              </h2>
              <p className="text-xl text-muted-foreground">
                We're proud to work with amazing brands across various
                industries
              </p>
            </div>
