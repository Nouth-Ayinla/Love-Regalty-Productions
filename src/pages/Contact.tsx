...
Looking forward to hearing from you!`;
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Phone,
      title: "Phone",
      content: "+234 805 123 4567",
      action: "tel:+2348051234567",
    },
    {
      icon: MapPin,
      title: "Location",
        ...
        <section className="py-6 sm:py-8 lg:py-12">
          <div className="container mx-auto px-4 sm:px-6">
            ...
            <div className="text-center">
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold mb-3 sm:mb-4 lg:mb-6 text-muted-foreground text-orange-400">
                Get in Touch
              </h1>
              ...
              <div className="space-y-3 sm:space-y-4 lg:space-y-6">
                ...
                <Card className="shadow-lg bg-gradient-to-br from-brand-orange/10 to-brand-green/10">
                  <CardContent className="p-4 sm:p-6">
                    <h3 className="font-bold mb-2 text-lg sm:text-xl text-muted-foreground">
                      Why Choose Us?
                    </h3>
